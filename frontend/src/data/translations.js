export const translations = {
  en: {
    ...
    overlay: {
      waitingForBroadcast: "WAITING FOR BROADCAST",
      live: "LIVE",
      player: "Player",
      sold: "SOLD",
      unsold: "UNSOLD",
      ...
      openingBidPending: "Opening bid pending…",
  ...
  hi: {
    ...
    overlay: {
      waitingForBroadcast: "प्रसारण की प्रतीक्षा",
      live: "लाइव",
      player: "खिलाड़ी",
      sold: "बिक गया",
      unsold: "नहीं बिका",
      ...
      highestBidder: "उच्चतम बोलीदाता",
      awaitingBids: "बोलियों की प्रतीक्षा",
      openingBidPending: "प्रारंभिक बोली लंबित…",
      bidHistory: "बोली इतिहास",
      breakTime: "ब्रेक समय",
      weWillBeBack: "हम वापस आएंगे",
      minutes: "मिनट में",
      lunchBreak: "लंच ब्रेक",
      teaBreak: "चाय ब्रेक",
      shortBreak: "छोटा ब्रेक",
      technicalBreak: "तकनीकी ब्रेक"
    },
    hero: {
  ...
  kn: {
    ...
    overlay: {
      waitingForBroadcast: "ಪ್ರಸಾರಕ್ಕಾಗಿ ಕಾಯುತ್ತಿದೆ",
      live: "ಲೈವ್",
      player: "ಆಟಗಾರ",
      sold: "ಮಾರಾಟವಾಗಿದೆ",
      unsold: "ಮಾರಾಟವಾಗಿಲ್ಲ",
      ...
      basePrice: "ಮೂಲ ಬೆಲೆ",
      highestBidder: "ಅತಿ ಹೆಚ್ಚು ಬಿಡ್ದಾರ",
      awaitingBids: "ಬಿಡ್ಗಳಿಗಾಗಿ ಕಾಯುತ್ತಿದೆ",
      openingBidPending: "ಆರಂಭಿಕ ಬಿಡ್ ಬಾಕಿ ಇದೆ…",
      bidHistory: "ಬಿಡ್ ಇತಿಹಾಸ",
      breakTime: "ವಿರಾಮ ಸಮಯ",
