          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full p-4 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
              <div className="flex justify-between items-end mb-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <span className="bg-violet-600/90 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded">
                  {data.year}
                </span>
                <span className="bg-slate-800/90 text-violet-400 text-[10px] uppercase font-bold px-2 py-0.5 rounded border border-slate-700">
                  {data.teams}
                </span>
              </div>
              ...
              <div className="flex items-center text-gray-300 text-xs mt-1">
                <svg className="w-3 h-3 mr-1 text-violet-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                {data.location}
              </div>
            </div>
          </div>
