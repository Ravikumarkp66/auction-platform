...
import {
  ...
  Edit2, Save, Plus, Clock, Settings } from
"lucide-react";
...
export default function PlayerRegistrationPage() {
  ...
  useEffect(() => {
    ...
    const updateCountdown = () => {
      ...
      if (diff <= 0) {
        ...
        if (diffDays === 0) setDateLabel("Today");else
        if (diffDays === 1) setDateLabel("Tomorrow");else
        setDateLabel(new Date(tournament.registrationEndDate).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' }));
      }
    };
  ...
  const fetchTournamentDetails = async () => {
    ...
    } catch (err) {setError("Network Isolation Error.");} finally
    {setLoading(false);}
  };
  ...
  const handleSubmit = async (e) => {
    ...
    {setSubmitting(false);setSubmissionPhase("");}
  };
